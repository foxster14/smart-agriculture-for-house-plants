...
from data_publisher.DataPublisher import DataPublisher
...
def main():
    ...
    while True:
        ...
        if not data_string == None:
            data_streamer.send_data(data_string) #sends via serial
            data_publisher.send_data(data_string) #sends via mqtt
